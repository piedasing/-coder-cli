			...
			CKEDITOR.dialog.add( 'youtube', function ( instance )
			{
				...
				return {
								...
								},
								{
									...
									[
										...
										},
										{
											...
											'default' : editor.config.youtube_width != null ? editor.config.youtube_width : '100%',
											validate : function ()
											{
												if ( this.getValue() )
												{
					...
					onOk: function()
					{
						...
						{
							content = '<div class="yt_wrapper">'+this.getValueOf( 'youtubePlugin', 'txtEmbed' )+'</div>';
						}
						else {
							...
							if ( this.getContentElement( 'youtubePlugin', 'chkOlderCode' ).getValue() === true )
							{
								...
								content += '<div class="yt_wrapper"><iframe width="' + width + '" height="' + height + '" src="' + url + '" ' + responsiveStyle;
